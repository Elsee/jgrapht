    ...
    extends TestCase
{
    ...
    public void testCompareWithDijkstra()
    {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            FloydWarshallShortestPaths<Integer, DefaultWeightedEdge> fw = new FloydWarshallShortestPaths<>(undirected);
    ...
    {
        SimpleWeightedGraph<String, DefaultWeightedEdge> weighted =
