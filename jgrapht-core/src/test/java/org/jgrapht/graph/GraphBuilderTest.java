    ...
    extends EnhancedTestCase
{
    ...
    public void testAddVertex()
    {
        Graph<String, DefaultEdge> g =
            new GraphBuilder<>(new SimpleGraph<String, DefaultEdge>(DefaultEdge.class))
    ...
    {
        Graph<String,
            DefaultEdge> g = new GraphBuilder<>(
    ...
    public void testAddGraphOldInterfaces()
    {
        ...
        Graph<String,
            DefaultEdge> g2 = new GraphBuilder<>(
                new SimpleGraph<String, DefaultEdge>(DefaultEdge.class))
                    .addGraph(g1).addEdge(v1, v4).build();
    ...
    {
        Graph<String,
            DefaultEdge> g1 = new GraphBuilder<>(
                new SimpleGraph<String, DefaultEdge>(DefaultEdge.class))
